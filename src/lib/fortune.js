...
- text: 5~6문장으로 달마다 다른 결. 무슨 일이 일어날 수 있는지 구체적 상황을 담고, 어떻게 흘러가면 좋은지 방향을 제시하세요. 월마다 톤과 내용이 뚜렷이 달라야 합니다.
...
분량 지침:
- lifeEarly·lifeMid·lifeLate: 각 6~7문장. 각 시기의 주된 과제, 빛나는 순간, 조심해야 할 패턴을 구체적으로. 나이대(20대, 30대 등)를 언급해 체감되게.
- years: ${YEAR}년부터 5년치. 각각 keyword(그 해의 핵심 2~4자)와 text(5~6문장, 그 해에 어떤 기운이 오고 어떻게 활용하면 좋은지를 구체적으로).
...
- closing: ${userName}님을 향한 시적이고 따뜻한 맺음말 3~4문장(따옴표 없이, 리포트의 마지막 페이지에 크게 인쇄될 문장들이에요).`,
    user: `${userName}님, 일주 ${ilju}. 초년·중년·말년의 흐름, ${YEAR}년부터 향후 5년, 인생 조언, 맺음말을 작성해 주세요.`,
    schema: S({
      lifeEarly: STR, lifeMid: STR, lifeLate: STR,
      years: AOBJ({ keyword: STR, text: STR }, ['keyword','text']),
